...
INSERT INTO `usuario` (`id`,`nombre`, `apellido`, `tipo_usuario`, `codigo_viajero`)
                     VALUES (NULL, 'Ezequiel', 'Paoloni', 1, 0),
                            (NULL, 'Ian', 'Tries', 1, 0),
                            (NULL, 'Alejo', 'Zonta', 1, 0),
                            (NULL, 'Juan', 'Pérez', 2, 1);

INSERT INTO `credencial` (`id`, `username`, `pass`,`usuario`)
                     VALUES (NULL, 'ezep', '1234',1),
                            (NULL, 'iant', '1234',2),
                            (NULL, 'alejoz', '1234',3),
							(NULL, 'juanp', '1234',4);
